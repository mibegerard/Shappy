...
const ProductCartCard = ({ item, onDelete, onQuantityChange, sx }) => {
    ...
    console.log('Producteur:', item.product.producteur?.firstName);
            ...
            <Box sx={{ flex: 1, marginLeft: '1rem' }}>
                ...
                <Grid container spacing={1}>
                    <Grid item xs={12} container direction="column" alignItems="flex-start">
                        ...
                        >
                          Prix: {item.product.price} € / {item.product.unit}
                        </Typography>
                            ...
                            <Grid item xs={12}>
                                ...
                                >
                                    <Typography
                                        ...
                                        sx={{ color: vertFonce, padding: '5px 0' }}
                                    >
                                        En stock: {item.product.quantity} {item.product.unit}
                                    </Typography>
                                </Box>
                            </Grid>
                        </Grid>
                        <Typography sx={{ color: vertFonce, padding: '5px 0' }}>
                            Producteur: {item.product.producteur?.firstName}
                        </Typography>
