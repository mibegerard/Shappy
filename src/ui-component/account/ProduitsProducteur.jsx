...
const ProduitsProducteur = () => {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            ...
            try {
                ...
                console.error('Error fetching products in the page:', error);
            }
        };
    ...
    if (!products || products.length === 0) {
        return <Typography variant="h6" align="center">Rétrouvez ici vos produits recemment ajoutés.</Typography>;
    }
    ...
    return (
        <Container maxWidth="lg">
            ...
            >
                ...
                >
                    Mes Produits Récemment Ajoutés
                </Typography>
            </Box>
...
export default ProduitsProducteur;