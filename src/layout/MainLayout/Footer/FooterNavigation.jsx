...
const FooterNavigation = () => {
  ...
  <Grid item xs={12} md={5}> {/* Increased size */}
    <Box display="flex" flexDirection="column">
      ...
      <Typography variant="h2" sx={{ textAlign: 'left', mb: 2, color: '#FC8A1A', fontSize: '1.6rem' }}>
        ABBONEZ-VOUS À NOTRE NEWS FRUITÉ
      </Typography>
      <Box display="flex" alignItems="center" justifyContent="space-between" sx={{ padding: '0.5rem', backgroundColor: '#FC8A1A', borderRadius: '0.5rem' }}>
        <EmailIcon />
